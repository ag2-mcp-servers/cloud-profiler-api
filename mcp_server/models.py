...
class Profile(BaseModel):
    deployment: Optional[Deployment] = Field(
        None, description='Deployment this profile corresponds to.'
    )
    ...
    profileBytes: Optional[str] = Field(
        None,
...
class CreateProfileRequest(BaseModel):
    deployment: Optional[Deployment] = Field(None, description='Deployment details.')
    profileType: Optional[List[ProfileTypeEnum]] = Field(
        None,
